    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="update-estados.php?id=<?php echo $idrostoedicao; ?>" name="formEdicaoRostoControlDoc"
                  method="POST">
                <button type="submit" name="action" value="toPublish" class="btn btn-danger">Publicar</button>
                <button type="submit" name="action" value="toValidate" class="btn btn-info">Remeter para Aprovação
                </button>
            </form>
            <br>
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <form action="saveedicaorosto.php?id=<?php echo $idrostoedicao; ?>"
