...
<section class="content">
	...
	<div class="box box-info">
		<div class="box-header with-border">
			...
			<button type="button" class="btn btn-warning">Submeter para aprovação</button>
...
<div class="box-body">
	...
	<dl class="dl-horizontal">
		...
		<dd class="native"><?php echo $objectivo; ?></dd><br><br>
		<dd class="editing"><input type="text" style="min-width: 100%;" value="<?php echo $objectivo; ?>"></dd><br><br>
			<dt>Âmbito de Procedimento</dt>
			<dd class="native"><?php echo $ambito; ?></dd> <br><br>
			<dt>Entradas</dt>
			<dd class="native"><?php echo $entradas; ?></dd> <br><br>
			<dt >Saídas</dt>
