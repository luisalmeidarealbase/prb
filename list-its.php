 ...
 <div class="box box-info">
  ...
  <div class="box-body" style="display: block;">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title sub-titulo-1">lksad nsadkj safljhk</h3>
                                <!--<div class="box-tools pull-right">
                                ...
                                <div class="box-body" style="display: block;">
                                  ...
                                  $queryIt = "SELECT * FROM tbl_its WHERE tbl_procedimentos_id_procedimento = '$idProc'";
                                  $resultQueryIt = mysqli_query($link, $queryIt);

                                  while ($rowIt = mysqli_fetch_object($resultQueryIt)) {

                                    # code...
                                    $objectivoIt = htmlentities($rowIt->objectivo_it);
                                    $idIt = $rowIt->id_it;
