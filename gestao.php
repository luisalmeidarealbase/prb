...
function checkEditMode()
{
    ...
    */
    ...
    INNER JOIN tbl_procedimentos ON tbl_procedimentos.id_procedimento = tbl_rostos.tbl_procedimentos_id_procedimento
    WHERE id_procedimento = 1 AND publicado_versao_rosto = 0 AND aprovado_versao_rosto = 0 AND historico_versao_rosto != 1";
    ...
    INNER JOIN tbl_procedimentos ON tbl_procedimentos.id_procedimento = tbl_rostos.tbl_procedimentos_id_procedimento
    WHERE id_procedimento = 1 AND publicado_versao_rosto = 0 AND aprovado_versao_rosto = 1 AND validado_versao_rosto = 0 AND historico_versao_rosto != 1";
    ...
    INNER JOIN tbl_procedimentos ON tbl_procedimentos.id_procedimento = tbl_rostos.tbl_procedimentos_id_procedimento
    WHERE id_procedimento = 1 AND publicado_versao_rosto = 0 AND aprovado_versao_rosto = 1 AND validado_versao_rosto = 1 AND historico_versao_rosto != 1";
    ...
    if ($countEdit > 0) {
        ...
        header('location: edicao-gestao.php');
    }
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Gestão Estratégica, Qualidade e de Cadeia de Custódia<br>
                <small>Recreating DNA</small>
            </h1>
            <br>
            <div class="btn-group">
                <a href="gestao.php?edit=true">
                    <button type="button" class="btn btn-info">Editar Procedimento</button>

                </a>
                <a href="procedimento-historico.php?id=1">
        ...
        <section class="content">
            ...
            <div class="box box-info">
                ...
                <div class="box-body" style="display: block;">
                    ...
                    $queryrosto = "SELECT * FROM tbl_procedimentos INNER JOIN tbl_rostos ON id_procedimento = tbl_procedimentos_id_procedimento INNER JOIN tbl_versoes_rostos ON id_rosto = tbl_rostos_id_rosto  WHERE tbl_versoes_rostos.publicado_versao_rosto = 1 AND id_procedimento = 1";
                    ...
                    <div class="col-md-6">
                        ...
                        <embed src="fluxogramas/fluxogramagestao.pdf" style="min-width: 100%;  min-height: 500px;" class="img-responsive"
