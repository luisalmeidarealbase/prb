...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Procedimento - Gestão<br>
      <small>Bem-vindo à página do procedimento - Gestão. Aqui pode consultar toda a informação do procedimento. </small>
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs pull-right">
       ...
       <li class="pull-left header"><i class="fa fa-th"></i> Docs - Gestão</li>
     </ul>
     <div class="tab-content">
      <div class="tab-pane active" id="tab_1-1">
        ...
        $queryrosto = "SELECT * FROM tbl_rostos INNER JOIN tbl_procedimentos ON tbl_rostos.tbl_procedimentos_id_procedimento = tbl_procedimentos.id_procedimento WHERE id_procedimento = 1 ORDER BY id_rosto DESC LIMIT 1";
